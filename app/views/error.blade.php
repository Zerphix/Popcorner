...
<html lang="es">
    ...
    <head>
        ...
        <title>@yield('title', '¡Oh Snap!')</title>
        <meta name="Copyright" content="edtorm@outlook.com">
    </head>
<body>
<div id="page">

  <h1 id="message" align="center"><strong>Grats.</strong> You broke it.</h1>
  <h3 id="message" align="center">
    This page doesn't exist or some other horrible error has occured.
  </h3>
